...
- Choose **Quick 4 · 40 life**, **Quick 2 · 20 life**, or customize a table. Tap life controls or hold to repeat. Open a player's name for **Edit player & commanders**, exact values, poison, commander tools, and rotation. Renaming keeps all recorded damage and casts. Undo groups an uninterrupted hold while each increment is saved immediately.
